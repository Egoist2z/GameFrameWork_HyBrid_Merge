...
namespace DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        public static DataTableProcessor CreateDataTableProcessor(string dataTableName,string DataTablePath)
        {
        ...
        public static void GenerateDataFile(DataTableProcessor dataTableProcessor, string dataTableName,string DataTablePath)
        {
        ...
        public static void GenerateCodeFile(DataTableProcessor dataTableProcessor, string dataTableName,string CSharpCodeTemplateFileName,string CSharpCodePath)
        {
